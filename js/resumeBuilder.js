...
$(function() {
  ...
  var controller = {
    ...
    formatBio() {
      ...
      bioArr.push(name, role, email, mobile, git, location, pic, welcome);
    ...
    formatEdu() {
      ...
      schoolArr.push([
        ...
        location,
        major
      ], [HTMLonlineClasses, onlineClasses]);
  ...
  */
    function createMapMarker(placeData) {
      ...
      var marker = new google.maps.Marker({map: map, position: placeData.geometry.location, title: name});
